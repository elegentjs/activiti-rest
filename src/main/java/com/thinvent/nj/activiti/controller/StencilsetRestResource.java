...
public class StencilsetRestResource extends AbstractActivitController {
  
  @RequestMapping(value="/editor/stencilset", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
  public String getStencilset() throws IOException {
    InputStream stencilsetStream = new ClassPathResource("static/stencilset.json").getInputStream();
